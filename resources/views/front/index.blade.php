...
@section('content')
    ...
    <section class="mb-4 relative bg-cover bg-center min-h-screen md:h-screen w-full"
        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 ">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <p class="max-w-2xl mb-6 font-base text-gray-100 font-poppins lg:mb-10 md:text-lg lg:text-xl dark:text-white">
                    Sebagai
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="lg:order-1 order-2 mr-auto place-self-center lg:col-span-7">
                ...
                <h1
                    class="max-w-2xl mb-4 mt-2 text-4xl tracking-normal font-playfair font-extrabold leading-none md:text-5xl md:mb-9 xl:text-6xl dark:text-white">
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <div class="order-2 lg:order-2 lg:col-span-6 mb-5 place-self-center lg:text-left">
                ...
                <p
                    class="max-w-2xl mt-9 mb-7 font-base font-poppins text-gray-600 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
    ...
    <section class="bg-customLightYellow">
        <div class="grid max-w-screen-xl px-4 py-6 mx-auto lg:gap-8 xl:gap-0 lg:py-3 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <p
                    class="max-w-2xl mb-6 font-poppins font-base text-gray-600 lg:mb-8 md:text-lg lg:text-xl dark:text-black">
                    A tightly curated online journey to a better self and a better married life</p>

                <a href="#"
                    class="inline-flex bg-customLightGreen items-center justify-center px-7 py-2 font-poppins font-semibold text-center text-white  rounded-3xl hover:bg-hoverCustomGreen hover:text-black focus:ring-4 focus:ring-gray-100 dark:text-white">
                    Start Here
                </a>
            </div>
