...
@section('content')
    ...
    <section class="relative bg-cover bg-center min-h-[50vh] md:min-h-screen w-full"
        style="background-image: url('{{ asset('assets/bg/bg-maps-coaching.svg') }}');">
    </section>
    ...
    <section class="flex justify-center items-center min-h-[20vh]">
        <a href="#"
            class="inline-flex font-bold font-poppins text-center bg-customYellow items-center justify-center px-5 py-2  text-white rounded-lg hover:bg-hoverCustomYellow hover:text-black focus:ring-4 focus:ring-gray-100 dark:text-white"
            id="openModalBtn">
            Start Your Journey
        </a>
    </section>
            ...
            <div id="default-carousel" class="relative w-full" data-carousel="slide">
                ...
                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ asset('assets/bg/bg-coaching.svg') }}"
    ...
    <!-- Modal -->
    <div id="myModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
        <div class="w-full max-w-md mx-auto">
            <div class="relative mx-3 bg-white shadow-lg rounded-lg overflow-hidden">
                <!-- Carousel Slides -->
                <div id="onboardingCarousel" class="relative h-72">
                    <div
                        ...
                        <a class="mb-10" href="#">
                            <img src="{{ asset('assets/icon/icon-pin-point-1.svg') }}" alt="Onboarding Image 2"
                    ...
                    <div
                        ...
                        <p class="mb-4">Keep in touch with your friends and family with our messaging features.</p>
                        <a class="mb-10" href="#">
                            <img src="{{ asset('assets/icon/icon-pin-point-2.svg') }}" alt="Onboarding Image 2"
                                class="w-24 h-24 rounded-full">
                        </a>
                    </div>
                    <div
                        ...
                        <p class="mb-4">Keep in touch with your friends and family with our messaging features.</p>
                        <a class="mb-10" href="#">
                            <img src="{{ asset('assets/icon/icon-pin-point-3.svg') }}" alt="Onboarding Image 2"
                                class="w-24 h-24 rounded-full">
                        </a>
                    </div>
                </div>
                ...
                <div class="absolute inset-x-0 bottom-0 mb-4 flex justify-between items-center px-4">
                    ...
                    <button id="closeModalBtn" class="text-black">Close</button>
                    <button id="nextBtn"
                        class="px-3 py-1 bg-gray-700 text-white rounded-lg hover:bg-gray-600">&#9654;</button>
                </div>
            </div>
    ...
    @push('after-scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Tampilkan modal ketika tombol dibuka diklik
